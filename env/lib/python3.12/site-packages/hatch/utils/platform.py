...
class Platform:
    ...
    def format_for_subprocess(
        self, command: str | list[str], *, shell: bool
    ) -> str | list[str]:
        """
    ...
    def _run_command_integrated(
        ...
        return self.modules.subprocess.CompletedProcess(
    ...
    def run_command(
        ...
        return self.modules.subprocess.run(
            self.format_for_subprocess(command, shell=shell), shell=shell, **kwargs
        )
    ...
    def populate_default_popen_kwargs(
        self, kwargs: dict[str, Any], *, shell: bool
    ) -> None:
    ...
    def default_shell(self) -> str:
        ...
        if self.__default_shell is None:
            if self.windows:
                self.__default_shell = cast(
                    str, os.environ.get("SHELL", os.environ.get("COMSPEC", "cmd"))
                )
            else:
