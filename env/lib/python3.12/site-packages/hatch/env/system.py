...
class SystemEnvironment(EnvironmentInterface):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.install_indicator = (
            self.data_directory / str(self.root).encode("utf-8").hex()
        )
    ...
    def install_project(self):
        self.platform.check_command(
            self.construct_pip_install_command([self.apply_features(str(self.root))])
        )
    ...
    def dependencies_in_sync(self):
        ...
        return dependencies_in_sync(
            ...
            sys_path=self.python_info.sys_path,
            environment=self.python_info.environment,
        )
