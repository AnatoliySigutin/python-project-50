...
def show(app: Application, *, force_ascii: bool, directory: str | None):
    ...
    installed_columns: dict[str, dict[int, str]] = {
        "Name": {},
        "Version": {},
        "Status": {},
    }
    ...
    app.display_table(
        "Installed", installed_columns, show_lines=True, force_ascii=force_ascii
    )
    app.display_table(
        "Available", available_columns, show_lines=True, force_ascii=force_ascii
    )
